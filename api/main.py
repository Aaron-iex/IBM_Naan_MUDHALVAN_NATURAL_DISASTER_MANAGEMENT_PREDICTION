# api/main.py
# Consolidated version integrating Weather, USGS Quakes, NASA Events, News, Geocoding, Gemini LLM
# Includes asynchronous context fetching using httpx
...
#from scrape_data import scrape_imd_special_bulletin 
